...
## Build Tools
- [Cake](https://cakebuild.net/) - Cake (C# Make) is a cross-platform build automation system with a C# DSL.
- [Fody](https://github.com/Fody/Fody) - Extensible tool for weaving .net assemblies.

## Data Structures and Algorithms
- [Fare](https://github.com/moodmosaic/Fare) - Fare is a .NET library for working with finite state machines.
...
- [MySqlConnector](https://mysqlconnector.net/) - MySqlConnector is a high-performance MySQL connector for .NET.
...
## Date and Time
- [NodaTime](https://nodatime.org/) - Noda Time is an alternative date and time API for .NET.
- [TimeZoneConverter](https://github.com/mattjohnsonpint/TimeZoneConverter) - TimeZoneConverter is a .NET library to convert IANA time zones to Windows time zones.

## Dependency Injection
- [Autofac](https://autofac.org/) - Autofac is an .NET IoC container.
- [Castle.Windsor](http://www.castleproject.org/projects/windsor/) - Castle Windsor is best of breed, mature Inversion of Control container available for .NET.
- [CommonServiceLocator](https://github.com/unitycontainer/commonservicelocator) - CommonServiceLocator is a simple library for providing a common way to locate services.
...
## Email
- [MailKit](https://www.mimekit.net/) - MailKit is a cross-platform mail client library built on top of MimeKit.
- [SendGrid](https://sendgrid.com/) - C# client library and examples for using Twilio SendGrid API's to send mail.

**[⬆ back to top](#contents)**

## Excel
- [ClosedXML](https://closedxml.github.io/ClosedXML/) - ClosedXML is a .NET library for reading, manipulating, and writing Excel 2007+ (.xlsx, .xlsm) files.
- [EPPlus](https://epplussoftware.com/) - EPPlus is a .NET library that reads and writes Excel files using the Office Open XML format (xlsx).
- [ExcelDataReader](https://github.com/ExcelDataReader/ExcelDataReader) - ExcelDataReader is a lightweight and fast library written in C# for reading Microsoft Excel files.
- [NPOI](https://npoi.apache.org/) - NPOI is a .NET library for reading and writing Microsoft Office file formats.

**[⬆ back to top](#contents)**

## File Handling
- [K4os.Compression.LZ4](https://github.com/MiloszKrajewski/K4os.Compression.LZ4) - Port of LZ4 compression algorithm for .NET
- [System.IO.Abstractions](https://github.com/TestableIO/System.IO.Abstractions) - A set of abstractions to help make file system interactions testable.
...
## HTTP Clients
- [Flurl.Net](https://flurl.dev/) - A fluent, testable HTTP client library.
...
## Image Processing
- [ImageSharp](https://sixlabors.com/products/imagesharp/) - ImageSharp is a new, fully featured, fully managed, cross-platform, 2D graphics API.
- [Magick.NET](https://magick.codeplex.com/) - Magick.NET is an advanced .NET library to work with images.
...
- [NCrontab](https://github.com/atifaziz/NCrontab) - NCrontab is a library for parsing crontab expressions.
- [Quartz.NET](https://www.quartz-scheduler.net/) - Quartz Scheduling Framework for .NET

**[⬆ back to top](#contents)**

## Logging
- [Common.Logging](https://net-commons.github.io/common-logging/) - Common.Logging is a portable logging abstraction for .NET.
...
- [Sentry](https://docs.sentry.io/platforms/dotnet/) - Official Microsoft.Extensions.Logging integration for Sentry.
...
## Messaging
- [Confluent.Kafka](https://github.com/confluentinc/confluent-kafka-dotnet/) - Confluent's .NET Client for Apache Kafka
...
- [Twilio](https://github.com/twilio/twilio-csharp) - Twilio is a C# library for communicating with the Twilio API.
...
## Science
- [MathNet.Numerics](https://numerics.mathdotnet.com/) - Math.NET Numerics aims to provide methods and algorithms for numerical computations.
- [NetTopologySuite](https://nettopologysuite.github.io/) - NetTopologySuite is a C#/.NET library providing geospatial functionalities.
- [NumSharp](https://github.com/SciSharp/NumSharp) - NumSharp is a .NET library that provides numerical computing functionality.
...
- [starkbank-ecdsa](https://github.com/starkbank/ecdsa-dotnet) - StarkBank ECDSA is a .NET library for Elliptic Curve Digital Signature Algorithm (ECDSA).
...
- [MessagePack](https://msgpack.org/) - MessagePack is a fast and compact binary serialization format for .NET.
...
- [Bogus](https://github.com/bchavez/Bogus) - A simple and sane data generator for populating objects that supports different locales.
...
- [NSubstitute](https://nsubstitute.github.io/) - NSubstitute is a friendly substitute for .NET mocking libraries.
- [NUnit](https://nunit.org/) - NUnit is a unit-testing framework for all .Net languages.
- [Shouldly](https://shouldly.org/) - Assertion framework for .NET.
...
## Text Processing
- [AngleSharp](https://anglesharp.github.io/) - AngleSharp is a .NET library that gives you the ability to parse angle bracket based hyper-texts like HTML, SVG, and MathML.
- [CsvHelper](https://joshclose.github.io/CsvHelper/) - CsvHelper is a library to help read and write CSV files.
- [ExcelNumberFormat](https://github.com/andersnm/ExcelNumberFormat) - .NET library to parse ECMA-376 number format strings and format values like Excel
...
- [NJsonSchema](http://njsonschema.org/) - NJsonSchema is a .NET library to read, generate, and validate JSON Schema.
- [ServiceStack.Text](https://servicestack.net/) - High-performance JSON, CSV, XML, etc. serializer and deserializer.
...
- [morelinq](https://morelinq.github.io/) - MoreLINQ is a set of extensions to LINQ to Objects.
...
## Uncategorized
- :m: [Microsoft.FeatureManagement](https://github.com/Azure/AppConfiguration) - Microsoft.FeatureManagement is a library for enabling feature flags in .NET applications.
- [MimeKit](https://mimekit.net/) - MimeKit is an Open Source library for creating and parsing MIME, S/MIME and PGP messages.
- [NuGet.Packaging](https://www.nuget.org/packages/NuGet.Packaging) - NuGet.Packaging is a .NET library for creating and reading NuGet packages.
- [prometheus-net](https://github.com/prometheus-net/prometheus-net) - .NET client library for the Prometheus monitoring and alerting system.
